...
public class FileRepositoryBuilder extends
		BaseRepositoryBuilder<org.eclipse.jgit.storage.file.FileRepositoryBuilder, Repository> {
	/**
	 * {@inheritDoc}
	 * <p>
	...
	public static Repository create(File gitDir) throws IOException {
		return new org.eclipse.jgit.storage.file.FileRepositoryBuilder().setGitDir(gitDir).readEnvironment()
				.build();
	}
}
