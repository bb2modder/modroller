 ...
 * {@link #takeBlame(EditList, org.eclipse.jgit.blame.Candidate)} to accept responsibility for sections
 * of the result.
 */
class Candidate {
	/** Next candidate in the candidate queue. */
	org.eclipse.jgit.blame.Candidate queueNext;
	...
	org.eclipse.jgit.blame.Candidate getNextCandidate(@SuppressWarnings("unused") int idx) {
		return null;
	}
	...
	org.eclipse.jgit.blame.Candidate create(Repository repo, RevCommit commit, PathFilter path) {
		return new org.eclipse.jgit.blame.Candidate(repo, commit, path);
	}

	org.eclipse.jgit.blame.Candidate copy(RevCommit commit) {
		org.eclipse.jgit.blame.Candidate r = create(sourceRepository, commit, sourcePath);
	...
	void takeBlame(EditList editList, org.eclipse.jgit.blame.Candidate child) {
		blame(editList, this, child);
	}

	private static void blame(EditList editList, org.eclipse.jgit.blame.Candidate a, org.eclipse.jgit.blame.Candidate b) {
	...
	private static Region add(Region aTail, org.eclipse.jgit.blame.Candidate a, Region n) {
	...
	boolean canMergeRegions(org.eclipse.jgit.blame.Candidate other) {
		return sourceCommit == other.sourceCommit
				&& sourcePath.getPath().equals(other.sourcePath.getPath());
	}

	void mergeRegions(org.eclipse.jgit.blame.Candidate other) {
	 ...
	 */
	static final class ReverseCandidate extends org.eclipse.jgit.blame.Candidate {
		...
		@Override
		org.eclipse.jgit.blame.Candidate create(Repository repo, RevCommit commit, PathFilter path) {
			return new org.eclipse.jgit.blame.Candidate.ReverseCandidate(repo, (ReverseCommit) commit, path);
		}
	...
	/**
	 * A {@link org.eclipse.jgit.blame.Candidate} to blame a working tree file in conflict state.
	 * <p>
	 * Contrary to {@link org.eclipse.jgit.blame.Candidate.BlobCandidate}, it expects to be given the parent
	 ...
	 * </p>
	 */
	static final class HeadCandidate extends org.eclipse.jgit.blame.Candidate {
	 ...
	 * <p>
	 * The {@link org.eclipse.jgit.blame.Candidate#sourceCommit} field is always null on this type of
	 ...
	 */
	static final class BlobCandidate extends org.eclipse.jgit.blame.Candidate {
		/**
		 ...
		 */
		org.eclipse.jgit.blame.Candidate parent;
		...
		@Override
		org.eclipse.jgit.blame.Candidate getNextCandidate(int idx) {
			return parent;
		}
