...
public class BlameResult {
	 ...
	 */
	public static org.eclipse.jgit.blame.BlameResult create(BlameGenerator gen) throws IOException {
		...
		return new org.eclipse.jgit.blame.BlameResult(gen, path, contents);
	}
