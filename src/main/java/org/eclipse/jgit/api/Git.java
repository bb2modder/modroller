...
public class Git implements AutoCloseable {
	 ...
	 * @throws IOException
	 */
	public static org.eclipse.jgit.api.Git open(File dir) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static org.eclipse.jgit.api.Git open(File dir, FS fs) throws IOException {
		...
		return new org.eclipse.jgit.api.Git(db, true);
	}
	 ...
	 */
	public static org.eclipse.jgit.api.Git wrap(Repository repo) {
		return new org.eclipse.jgit.api.Git(repo);
	}
	 ...
	 * {@link org.eclipse.jgit.api.Git} instance anymore.
	 *
	 * @since 3.2
	 */
	@Override
