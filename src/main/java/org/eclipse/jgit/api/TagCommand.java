...
public class TagCommand extends GitCommand<Ref> {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.TagCommand setName(String name) {
		checkCallable();
		this.name = name;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.TagCommand setMessage(String message) {
		checkCallable();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.TagCommand setSigned(boolean signed) {
		this.signed = signed;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.TagCommand setTagger(PersonIdent tagger) {
		this.tagger = tagger;
		return this;
	}
	 ...
	 *
	 * @param id
	 *            a {@link RevObject} object.
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.TagCommand setObjectId(RevObject id) {
		this.id = id;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.TagCommand setForceUpdate(boolean forceUpdate) {
	 ...
	 * @since 3.0
	 */
	public org.eclipse.jgit.api.TagCommand setAnnotated(boolean annotated) {
