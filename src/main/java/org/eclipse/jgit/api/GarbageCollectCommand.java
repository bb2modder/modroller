...
public class GarbageCollectCommand extends GitCommand<Properties> {
	 ...
	 */
	public org.eclipse.jgit.api.GarbageCollectCommand setProgressMonitor(ProgressMonitor monitor) {
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.GarbageCollectCommand setExpire(Date expire) {
		this.expire = expire;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.GarbageCollectCommand setAggressive(boolean aggressive) {
		if (aggressive) {
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.GarbageCollectCommand setPreserveOldPacks(boolean preserveOldPacks) {
		if (pconfig == null)
			pconfig = new PackConfig(repo);
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.GarbageCollectCommand setPrunePreserved(boolean prunePreserved) {
		if (pconfig == null)
			pconfig = new PackConfig(repo);
