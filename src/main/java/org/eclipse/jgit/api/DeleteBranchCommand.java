...
public class DeleteBranchCommand extends GitCommand<List<String>> {
	 ...
	 */
	public org.eclipse.jgit.api.DeleteBranchCommand setBranchNames(String... branchnames) {
		checkCallable();
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.DeleteBranchCommand setForce(boolean force) {
		checkCallable();
		this.force = force;
		return this;
	}
