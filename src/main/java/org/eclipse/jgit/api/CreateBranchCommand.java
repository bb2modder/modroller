...
public class CreateBranchCommand extends GitCommand<Ref> {
	 ...
	 */
	public org.eclipse.jgit.api.CreateBranchCommand setName(String name) {
		checkCallable();
		this.name = name;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CreateBranchCommand setForce(boolean force) {
		checkCallable();
		this.force = force;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CreateBranchCommand setStartPoint(String startPoint) {
		checkCallable();
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CreateBranchCommand setStartPoint(RevCommit startPoint) {
		checkCallable();
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CreateBranchCommand setUpstreamMode(SetupUpstreamMode mode) {
		checkCallable();
