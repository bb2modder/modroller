...
public class PushCommand extends
		TransportCommand<org.eclipse.jgit.api.PushCommand, Iterable<PushResult>> {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.PushCommand setRemote(String remote) {
		checkCallable();
		this.remote = remote;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.PushCommand setReceivePack(String receivePack) {
		checkCallable();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.PushCommand setProgressMonitor(ProgressMonitor monitor) {
		checkCallable();
		if (monitor == null) {
	 ...
	 * @since 4.7
	 */
	public org.eclipse.jgit.api.PushCommand setRefLeaseSpecs(RefLeaseSpec... specs) {
	 ...
	 * @since 4.7
	 */
	public org.eclipse.jgit.api.PushCommand setRefLeaseSpecs(List<RefLeaseSpec> specs) {
		checkCallable();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.PushCommand setRefSpecs(RefSpec... specs) {
		checkCallable();
		this.refSpecs.clear();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.PushCommand setRefSpecs(List<RefSpec> specs) {
		checkCallable();
		this.refSpecs.clear();
	 ...
	 * @return {@code this}.
	 */
	public org.eclipse.jgit.api.PushCommand add(Ref ref) {
	 ...
	 */
	public org.eclipse.jgit.api.PushCommand add(String nameOrSpec) {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.PushCommand setDryRun(boolean dryRun) {
		checkCallable();
		this.dryRun = dryRun;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.PushCommand setThin(boolean thin) {
		checkCallable();
		this.thin = thin;
		return this;
	}
	 ...
	 * @since 4.2
	 */
	public org.eclipse.jgit.api.PushCommand setAtomic(boolean atomic) {
		checkCallable();
		this.atomic = atomic;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.PushCommand setForce(boolean force) {
		checkCallable();
		this.force = force;
		return this;
	}
	 ...
	 * @since 3.0
	 */
	public org.eclipse.jgit.api.PushCommand setOutputStream(OutputStream out) {
		this.out = out;
		return this;
	}
	 ...
	 * @since 4.5
	 */
	public org.eclipse.jgit.api.PushCommand setPushOptions(List<String> pushOptions) {
