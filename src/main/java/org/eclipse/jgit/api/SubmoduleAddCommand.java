...
public class SubmoduleAddCommand extends
		TransportCommand<org.eclipse.jgit.api.SubmoduleAddCommand, Repository> {
	 ...
	 * @since 5.1
	 */
	public org.eclipse.jgit.api.SubmoduleAddCommand setName(String name) {
		this.name = name;
		return this;
	}
	 ...
	 * @return this command
	 */
	public org.eclipse.jgit.api.SubmoduleAddCommand setPath(String path) {
		this.path = path;
		return this;
	}
	 ...
	 * @return this command
	 */
	public org.eclipse.jgit.api.SubmoduleAddCommand setURI(String uri) {
		this.uri = uri;
		return this;
	}
	 ...
	 * @return this command
	 */
	public org.eclipse.jgit.api.SubmoduleAddCommand setProgressMonitor(ProgressMonitor monitor) {
