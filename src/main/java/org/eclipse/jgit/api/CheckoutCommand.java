...
import static org.eclipse.jgit.api.CheckoutResult.Status.*;
...
public class CheckoutCommand extends GitCommand<Ref> {
	...
	/**
	 * Stage to check out, see {@link org.eclipse.jgit.api.CheckoutCommand#setStage(Stage)}.
	 */
	public enum Stage {
		/**
		 * Base stage (#1)
	...
	public Ref call() throws GitAPIException, RefAlreadyExistsException,
		...
		try {
			...
			if (checkoutAllPaths || !paths.isEmpty()) {
				checkoutPaths();
				status = new CheckoutResult(OK, paths);
				setCallable(false);
				return null;
			}
			...
			try {
				...
				try {
					...
					status = new CheckoutResult(CONFLICTS,
							dco.getConflicts());
			...
			if (!dco.getToBeDeleted().isEmpty()) {
				status = new CheckoutResult(NONDELETED,
						dco.getToBeDeleted(),
	 ...
	 * @since 4.11
	 */
	public org.eclipse.jgit.api.CheckoutCommand setProgressMonitor(ProgressMonitor monitor) {
		if (monitor == null) {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CheckoutCommand addPath(String path) {
		checkCallable();
		this.paths.add(path);
		return this;
	}
	 ...
	 * @since 4.6
	 */
	public org.eclipse.jgit.api.CheckoutCommand addPaths(List<String> p) {
		checkCallable();
		this.paths.addAll(p);
		return this;
	}
	 ...
	 * @since 2.0
	 */
	public org.eclipse.jgit.api.CheckoutCommand setAllPaths(boolean all) {
	 ...
	 */
	protected org.eclipse.jgit.api.CheckoutCommand checkoutPaths() throws IOException,
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CheckoutCommand setName(String name) {
		checkCallable();
		this.name = name;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CheckoutCommand setCreateBranch(boolean createBranch) {
		checkCallable();
	 ...
	 * @since 3.3
	 */
	public org.eclipse.jgit.api.CheckoutCommand setOrphan(boolean orphan) {
		checkCallable();
		this.orphan = orphan;
		return this;
	}
	 ...
	 */
	@Deprecated
	public org.eclipse.jgit.api.CheckoutCommand setForce(boolean force) {
	 ...
	 * @since 5.3
	 */
	public org.eclipse.jgit.api.CheckoutCommand setForceRefUpdate(boolean forceRefUpdate) {
		checkCallable();
	 ...
	 * @since 5.3
	 */
	public org.eclipse.jgit.api.CheckoutCommand setForced(boolean forced) {
		checkCallable();
		this.forced = forced;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CheckoutCommand setStartPoint(String startPoint) {
		checkCallable();
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CheckoutCommand setStartPoint(RevCommit startCommit) {
		checkCallable();
	 ...
	 * @return this instance
	 */
	public org.eclipse.jgit.api.CheckoutCommand setUpstreamMode(
	 ...
	 * @return this
	 */
	public org.eclipse.jgit.api.CheckoutCommand setStage(Stage stage) {
		checkCallable();
