...
public class NameRevCommand extends GitCommand<Map<ObjectId, String>> {
	 ...
	 */
	public org.eclipse.jgit.api.NameRevCommand add(ObjectId id) throws MissingObjectException,
	 ...
	 *             {@link Exception#getCause()}.
	 */
	public org.eclipse.jgit.api.NameRevCommand add(Iterable<ObjectId> ids)
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.NameRevCommand addPrefix(String prefix) {
		checkCallable();
		prefixes.add(prefix);
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.NameRevCommand addRef(Ref ref) {
		checkCallable();
		if (refs == null)
			refs = new ArrayList<>();
		refs.add(ref);
	...
	org.eclipse.jgit.api.NameRevCommand setMergeCost(int cost) {
		mergeCost = cost;
		return this;
	}
