...
public class BlameCommand extends GitCommand<BlameResult> {
	 ...
	 * @return this command
	 */
	public org.eclipse.jgit.api.BlameCommand setFilePath(String filePath) {
		this.path = filePath;
		return this;
	}
	 ...
	 * @return this command
	 */
	public org.eclipse.jgit.api.BlameCommand setDiffAlgorithm(DiffAlgorithm diffAlgorithm) {
	 ...
	 * @return this command
	 */
	public org.eclipse.jgit.api.BlameCommand setTextComparator(RawTextComparator textComparator) {
	 ...
	 * @return this command
	 */
	public org.eclipse.jgit.api.BlameCommand setStartCommit(AnyObjectId commit) {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.BlameCommand setFollowFileRenames(boolean follow) {
	 ...
	 */
	public org.eclipse.jgit.api.BlameCommand reverse(AnyObjectId start, AnyObjectId end)
			throws IOException {
	 ...
	 *             the repository cannot be read.
	 */
	public org.eclipse.jgit.api.BlameCommand reverse(AnyObjectId start, Collection<ObjectId> end)
			throws IOException {
