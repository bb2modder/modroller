...
public class StatusCommand extends GitCommand<Status> {
	 ...
	 * @since 3.6
	 */
	public org.eclipse.jgit.api.StatusCommand setIgnoreSubmodules(IgnoreSubmoduleMode mode) {
	 ...
	 * @since 3.1
	 */
	public org.eclipse.jgit.api.StatusCommand addPath(String path) {
		if (paths == null)
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.StatusCommand setWorkingTreeIt(WorkingTreeIterator workingTreeIt) {
	 ...
	 * @since 3.1
	 */
	public org.eclipse.jgit.api.StatusCommand setProgressMonitor(ProgressMonitor progressMonitor) {
