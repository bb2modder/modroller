...
public class AddNoteCommand extends GitCommand<Note> {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.AddNoteCommand setObjectId(RevObject id) {
		checkCallable();
		this.id = id;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.AddNoteCommand setMessage(String message) {
		checkCallable();
	 ...
	 */
	public org.eclipse.jgit.api.AddNoteCommand setNotesRef(String notesRef) {
		checkCallable();
