...
public class CommitCommand extends GitCommand<RevCommit> {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setMessage(String message) {
		checkCallable();
	 ...
	 * @since 4.2
	 */
	public org.eclipse.jgit.api.CommitCommand setAllowEmpty(boolean allowEmpty) {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setCommitter(PersonIdent committer) {
		checkCallable();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setCommitter(String name, String email) {
		checkCallable();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setAuthor(PersonIdent author) {
		checkCallable();
		this.author = author;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setAuthor(String name, String email) {
		checkCallable();
	 ...
	 */
	public org.eclipse.jgit.api.CommitCommand setAll(boolean all) {
		checkCallable();
		if (all && !only.isEmpty())
			throw new JGitInternalException(MessageFormat.format(
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setAmend(boolean amend) {
		checkCallable();
		this.amend = amend;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setOnly(String only) {
		checkCallable();
		if (all)
			throw new JGitInternalException(MessageFormat.format(
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setInsertChangeId(boolean insertChangeId) {
		checkCallable();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.CommitCommand setReflogComment(String reflogComment) {
	 ...
	 * @since 3.7
	 */
	public org.eclipse.jgit.api.CommitCommand setNoVerify(boolean noVerify) {
	 ...
	 * @since 3.7
	 */
	public org.eclipse.jgit.api.CommitCommand setHookOutputStream(PrintStream hookStdOut) {
	 ...
	 * @since 5.6
	 */
	public org.eclipse.jgit.api.CommitCommand setHookErrorStream(PrintStream hookStdErr) {
	 ...
	 * @since 4.5
	 */
	public org.eclipse.jgit.api.CommitCommand setHookOutputStream(String hookName,
	 ...
	 * @since 5.6
	 */
	public org.eclipse.jgit.api.CommitCommand setHookErrorStream(String hookName,
	 ...
	 * @since 5.3
	 */
	public org.eclipse.jgit.api.CommitCommand setSigningKey(String signingKey) {
		checkCallable();
	 ...
	 * @since 5.3
	 */
	public org.eclipse.jgit.api.CommitCommand setSign(Boolean sign) {
		checkCallable();
