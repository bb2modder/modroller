...
public class DescribeCommand extends GitCommand<String> {
	 ...
	 */
	public org.eclipse.jgit.api.DescribeCommand setTarget(ObjectId target) throws IOException {
	 ...
	 *             a pack file or loose object could not be read.
	 */
	public org.eclipse.jgit.api.DescribeCommand setTarget(String rev) throws IOException,
	 ...
	 * @since 4.0
	 */
	public org.eclipse.jgit.api.DescribeCommand setLong(boolean longDesc) {
	 ...
	 * @since 5.0
	 */
	public org.eclipse.jgit.api.DescribeCommand setTags(boolean tags) {
		this.useTags = tags;
		return this;
	}
	 ...
	 * @since 5.4
	 */
	public org.eclipse.jgit.api.DescribeCommand setAlways(boolean always) {
		this.always = always;
		return this;
	}
	 ...
	 * @since 4.9
	 */
	public org.eclipse.jgit.api.DescribeCommand setMatch(String... patterns) throws InvalidPatternException {
