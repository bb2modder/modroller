 ...
 */
public class FetchCommand extends TransportCommand<org.eclipse.jgit.api.FetchCommand, FetchResult> {
			...
			while (walk.next()) {
				try (Repository submoduleRepo = walk.getRepository()) {
					...
					if ((recurseMode == FetchRecurseSubmodulesMode.ON_DEMAND
						...
						org.eclipse.jgit.api.FetchCommand f = new org.eclipse.jgit.api.FetchCommand(submoduleRepo)
	 ...
	 * @since 4.7
	 */
	public org.eclipse.jgit.api.FetchCommand setRecurseSubmodules(
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setRemote(String remote) {
		checkCallable();
		this.remote = remote;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setCheckFetchedObjects(boolean checkFetchedObjects) {
		checkCallable();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setRemoveDeletedRefs(boolean removeDeletedRefs) {
		checkCallable();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setProgressMonitor(ProgressMonitor monitor) {
		checkCallable();
		if (monitor == null) {
	 ...
	 * @since 4.9
	 */
	public org.eclipse.jgit.api.FetchCommand setRefSpecs(String... specs) {
		return setRefSpecs(
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setRefSpecs(RefSpec... specs) {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setRefSpecs(List<RefSpec> specs) {
		checkCallable();
		this.refSpecs.clear();
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setDryRun(boolean dryRun) {
		checkCallable();
		this.dryRun = dryRun;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setThin(boolean thin) {
		checkCallable();
		this.thin = thin;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.api.FetchCommand setTagOpt(TagOpt tagOpt) {
		checkCallable();
	 ...
	 * @since 4.8
	 */
	public org.eclipse.jgit.api.FetchCommand setCallback(Callback callback) {
	 ...
	 * @since 5.0
	 */
	public org.eclipse.jgit.api.FetchCommand setForceUpdate(boolean force) {
