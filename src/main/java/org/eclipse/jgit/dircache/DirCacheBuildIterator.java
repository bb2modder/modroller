...
public class DirCacheBuildIterator extends DirCacheIterator {
	...
	DirCacheBuildIterator(final org.eclipse.jgit.dircache.DirCacheBuildIterator p,
	...
	public AbstractTreeIterator createSubtreeIterator(ObjectReader reader)
		...
		if (currentSubtree == null)
			throw new IncorrectObjectTypeException(getEntryObjectId(),
					Constants.TYPE_TREE);
		return new org.eclipse.jgit.dircache.DirCacheBuildIterator(this, currentSubtree);
	}
