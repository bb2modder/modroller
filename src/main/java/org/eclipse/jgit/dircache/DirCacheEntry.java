...
public class DirCacheEntry {
	...
	DirCacheEntry(byte[] sharedInfo, MutableInteger infoAt, InputStream in,
			...
			org.eclipse.jgit.dircache.DirCacheEntry previous)
			throws IOException {
		info = sharedInfo;
	 ...
	 * @since 4.2
	 */
	public DirCacheEntry(org.eclipse.jgit.dircache.DirCacheEntry src) {
		path = src.path;
		info = new byte[INFO_LEN];
		infoOffset = 0;
	...
	void write(OutputStream os, DirCacheVersion version, org.eclipse.jgit.dircache.DirCacheEntry previous)
			throws IOException {
	 ...
	 */
	public void copyMetaData(org.eclipse.jgit.dircache.DirCacheEntry src) {
	 ...
	 */
	void copyMetaData(org.eclipse.jgit.dircache.DirCacheEntry src, boolean keepStage) {
