...
public class DirCache {
	...
	public static org.eclipse.jgit.dircache.DirCache newInCore() {
		return new org.eclipse.jgit.dircache.DirCache(null, null);
	}
	 ...
	 * @since 4.2
	 */
	public static org.eclipse.jgit.dircache.DirCache read(ObjectReader reader, AnyObjectId treeId)
			throws IOException {
		org.eclipse.jgit.dircache.DirCache d = newInCore();
	 ...
	 */
	public static org.eclipse.jgit.dircache.DirCache read(Repository repository)
			throws CorruptObjectException, IOException {
		final org.eclipse.jgit.dircache.DirCache c = read(repository.getIndexFile(), repository.getFS());
	 ...
	 *             library does not support.
	 */
	public static org.eclipse.jgit.dircache.DirCache read(File indexLocation, FS fs)
			throws CorruptObjectException, IOException {
		final org.eclipse.jgit.dircache.DirCache c = new org.eclipse.jgit.dircache.DirCache(indexLocation, fs);
		c.read();
		return c;
	}
	 ...
	 *             library does not support.
	 */
	public static org.eclipse.jgit.dircache.DirCache lock(File indexLocation, FS fs)
			throws CorruptObjectException, IOException {
		final org.eclipse.jgit.dircache.DirCache c = new org.eclipse.jgit.dircache.DirCache(indexLocation, fs);
		if (!c.lock())
	 ...
	 * @since 2.0
	 */
	public static org.eclipse.jgit.dircache.DirCache lock(final Repository repository,
	                                                      final IndexChangedListener indexChangedListener)
			throws CorruptObjectException, IOException {
		org.eclipse.jgit.dircache.DirCache c = lock(repository.getIndexFile(), repository.getFS(),
	 ...
	 *             library does not support.
	 */
	public static org.eclipse.jgit.dircache.DirCache lock(final File indexLocation, final FS fs,
	                                                      IndexChangedListener indexChangedListener)
			throws CorruptObjectException,
			IOException {
		org.eclipse.jgit.dircache.DirCache c = lock(indexLocation, fs);
