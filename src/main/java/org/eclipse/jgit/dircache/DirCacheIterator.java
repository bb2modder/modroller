...
public class DirCacheIterator extends AbstractTreeIterator {
	...
	DirCacheIterator(org.eclipse.jgit.dircache.DirCacheIterator p, DirCacheTree dct) {
	...
	public AbstractTreeIterator createSubtreeIterator(ObjectReader reader)
		...
		if (currentSubtree == null)
			throw new IncorrectObjectTypeException(getEntryObjectId(),
					Constants.TYPE_TREE);
		return new org.eclipse.jgit.dircache.DirCacheIterator(this, currentSubtree);
	}
