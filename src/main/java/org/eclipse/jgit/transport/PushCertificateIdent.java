...
public class PushCertificateIdent {
	 ...
	 */
	public static org.eclipse.jgit.transport.PushCertificateIdent parse(String str) {
		MutableInteger p = new MutableInteger();
		byte[] raw = str.getBytes(UTF_8);
		int tzBegin = raw.length - 1;
		tzBegin = lastIndexOfTrim(raw, ' ', tzBegin);
		if (tzBegin < 0 || raw[tzBegin] != ' ') {
			return new org.eclipse.jgit.transport.PushCertificateIdent(str, str, 0, 0);
		}
		...
		return new org.eclipse.jgit.transport.PushCertificateIdent(str, id, when * 1000L, tz);
	}
	...
	public boolean equals(Object o) {
		return (o instanceof org.eclipse.jgit.transport.PushCertificateIdent)
			&& raw.equals(((org.eclipse.jgit.transport.PushCertificateIdent) o).raw);
	}
