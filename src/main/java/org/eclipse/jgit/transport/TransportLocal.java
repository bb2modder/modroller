...
class TransportLocal extends Transport implements PackTransport {
	static final TransportProtocol PROTO_LOCAL = new TransportProtocol() {
		...
		public Transport open(URIish uri, Repository local, String remoteName)
			...
			return new org.eclipse.jgit.transport.TransportLocal(local, uri, gitDir);
		}
		...
		public Transport open(URIish uri) throws NotSupportedException,
			...
			return new org.eclipse.jgit.transport.TransportLocal(uri, gitDir);
		}
	};
	...
	public FetchConnection openFetch() throws TransportException {
		...
		return new org.eclipse.jgit.transport.InternalFetchConnection<>(this, upf, null, openRepo());
	}
	...
	class ForkLocalFetchConnection extends BasePackFetchConnection {
		...
		ForkLocalFetchConnection() throws TransportException {
			super(org.eclipse.jgit.transport.TransportLocal.this);
