...
public class ReceiveCommand {
	...
	public enum Result {
		...
		/** Other failure; see {@link org.eclipse.jgit.transport.ReceiveCommand#getMessage()}. */
	 ...
	 * @since 4.2
	 */
	public static List<org.eclipse.jgit.transport.ReceiveCommand> filter(Iterable<org.eclipse.jgit.transport.ReceiveCommand> in,
	                                                                     Result want) {
		List<org.eclipse.jgit.transport.ReceiveCommand> r;
		if (in instanceof Collection)
			r = new ArrayList<>(((Collection<?>) in).size());
		else
			r = new ArrayList<>();
		for (org.eclipse.jgit.transport.ReceiveCommand cmd : in) {
	 ...
	 * @since 2.0
	 */
	public static List<org.eclipse.jgit.transport.ReceiveCommand> filter(List<org.eclipse.jgit.transport.ReceiveCommand> commands,
	                                                                     Result want) {
		return filter((Iterable<org.eclipse.jgit.transport.ReceiveCommand>) commands, want);
	}
	 ...
	 * @since 4.2
	 */
	public static void abort(Iterable<org.eclipse.jgit.transport.ReceiveCommand> commands) {
		for (org.eclipse.jgit.transport.ReceiveCommand c : commands) {
	 ...
	 * @since 4.9
	 */
	public static boolean isTransactionAborted(org.eclipse.jgit.transport.ReceiveCommand cmd) {
	 ...
	 * @since 4.10
	 */
	public static org.eclipse.jgit.transport.ReceiveCommand link(@NonNull ObjectId oldId,
	                                                             @NonNull String newTarget, @NonNull String name) {
		return new org.eclipse.jgit.transport.ReceiveCommand(oldId, newTarget, name);
	}
	 ...
	 * @since 4.10
	 */
	public static org.eclipse.jgit.transport.ReceiveCommand link(@Nullable String oldTarget,
	                                                             @NonNull String newTarget, @NonNull String name) {
		return new org.eclipse.jgit.transport.ReceiveCommand(oldTarget, newTarget, name);
	}
	 ...
	 * @since 4.10
	 */
	public static org.eclipse.jgit.transport.ReceiveCommand unlink(@NonNull String oldTarget,
	                                                               @NonNull ObjectId newId, @NonNull String name) {
		return new org.eclipse.jgit.transport.ReceiveCommand(oldTarget, newId, name);
	}
	...
	private Result status = NOT_ATTEMPTED;
	...
	public void setResult(RefUpdate.Result r) {
		...
		case REJECTED_OTHER_REASON:
			setResult(REJECTED_OTHER_REASON);
			break;

		default:
			setResult(REJECTED_OTHER_REASON, r.name());
			break;
		}
	}

	void reject(IOException err) {
		setResult(REJECTED_OTHER_REASON, MessageFormat.format(
