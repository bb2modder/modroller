 ...
 *
 * @see UploadPack#setProtocolV2Hook(org.eclipse.jgit.transport.ProtocolV2Hook)
 * @since 5.1
 */
public interface ProtocolV2Hook {
	 ...
	 */
	static org.eclipse.jgit.transport.ProtocolV2Hook DEFAULT = new org.eclipse.jgit.transport.ProtocolV2Hook() {
		// No override.
	};
