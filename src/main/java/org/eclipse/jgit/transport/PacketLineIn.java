...
public class PacketLineIn {
	 ...
	 *             {@link org.eclipse.jgit.transport.PacketLineIn#readStrings()} to iterate over all
	 ...
	 * <p>
	 * Calls {@link #readString()} on the {@link org.eclipse.jgit.transport.PacketLineIn} until
	...
	public static class PacketLineInIterator implements Iterable<String> {
		private org.eclipse.jgit.transport.PacketLineIn in;

		private String current;

		PacketLineInIterator(org.eclipse.jgit.transport.PacketLineIn in) throws IOException {
			this.in = in;
