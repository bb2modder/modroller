...
/**
 * Hook invoked by {@link UploadPack} before during
 * critical phases.
 * <p>
 * If any hook function throws
 * {@link ServiceMayNotContinueException} then
...
public interface PreUploadHook {
	/** A simple no-op hook. */
	org.eclipse.jgit.transport.PreUploadHook NULL = new org.eclipse.jgit.transport.PreUploadHook() {
		@Override
