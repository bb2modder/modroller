...
public class RemoteRefUpdate {
	...
	public enum Status {
		 ...
		 * in {@link org.eclipse.jgit.transport.RemoteRefUpdate#getMessage()}.
		 */
	 ...
	 *            update. Use null or
	 *            {@link ObjectId#zeroId()} for delete
	 *            request.
	 * @param remoteName
	 *            full name of a remote ref to update, e.g. "refs/heads/master"
	 *            (no wildcard, no short name).
	 ...
	 */
	public RemoteRefUpdate(final org.eclipse.jgit.transport.RemoteRefUpdate base,
	 ...
	 *         {@link Repository#resolve(String)}; can be
