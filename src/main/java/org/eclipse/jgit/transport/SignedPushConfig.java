...
public class SignedPushConfig {
	...
	public static final SectionParser<org.eclipse.jgit.transport.SignedPushConfig> KEY =
			org.eclipse.jgit.transport.SignedPushConfig::new;
	 ...
	 * using the default
	 * {@link HMACSHA1NonceGenerator} implementation,
	...
	/**
	 * Set the {@link NonceGenerator} used for signed
	 * pushes.
	 * <p>
	 * Setting this to a non-null value enables push certificate verification.
	 * If this method is called, this implementation will be used instead of the
	 * default {@link HMACSHA1NonceGenerator} even if
	...
	/**
	 * Get the {@link NonceGenerator} used for signed
	 * pushes.
	 * <p>
	 ...
	 * newly-created {@link HMACSHA1NonceGenerator}.
	 *
