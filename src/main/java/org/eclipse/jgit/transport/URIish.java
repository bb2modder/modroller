...
public class URIish implements Serializable {
	...
	private URIish(org.eclipse.jgit.transport.URIish u) {
	 ...
	 */
	public org.eclipse.jgit.transport.URIish setHost(String n) {
		final org.eclipse.jgit.transport.URIish r = new org.eclipse.jgit.transport.URIish(this);
		r.host = n;
		return r;
	}
	 ...
	 * @return a new URI with the updated value.
	 */
	public org.eclipse.jgit.transport.URIish setScheme(String n) {
		final org.eclipse.jgit.transport.URIish r = new org.eclipse.jgit.transport.URIish(this);
		r.scheme = n;
		return r;
	}
	 ...
	 * @return a new URI with the updated value.
	 */
	public org.eclipse.jgit.transport.URIish setPath(String n) {
		final org.eclipse.jgit.transport.URIish r = new org.eclipse.jgit.transport.URIish(this);
		r.path = n;
		r.rawPath = n;
		return r;
	 ...
	 * @throws URISyntaxException
	 */
	public org.eclipse.jgit.transport.URIish setRawPath(String n) throws URISyntaxException {
		final org.eclipse.jgit.transport.URIish r = new org.eclipse.jgit.transport.URIish(this);
		r.path = unescape(n);
		r.rawPath = n;
		return r;
	 ...
	 * @return a new URI with the updated value.
	 */
	public org.eclipse.jgit.transport.URIish setUser(String n) {
		final org.eclipse.jgit.transport.URIish r = new org.eclipse.jgit.transport.URIish(this);
		r.user = n;
		return r;
	}
	 ...
	 * @return a new URI with the updated value.
	 */
	public org.eclipse.jgit.transport.URIish setPass(String n) {
		final org.eclipse.jgit.transport.URIish r = new org.eclipse.jgit.transport.URIish(this);
		r.pass = n;
		return r;
	}
	 ...
	 * @return a new URI with the updated value.
	 */
	public org.eclipse.jgit.transport.URIish setPort(int n) {
		final org.eclipse.jgit.transport.URIish r = new org.eclipse.jgit.transport.URIish(this);
		r.port = n > 0 ? n : -1;
		return r;
	}
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof org.eclipse.jgit.transport.URIish))
			return false;
		final org.eclipse.jgit.transport.URIish b = (org.eclipse.jgit.transport.URIish) obj;
