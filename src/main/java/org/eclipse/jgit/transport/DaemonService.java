...
public abstract class DaemonService {
	...
	DaemonService(String cmdName, String cfgName) {
		...
		configKey = cfg -> new ServiceConfig(org.eclipse.jgit.transport.DaemonService.this, cfg, cfgName);
		overridable = true;
	}
	...
	private static class ServiceConfig {
		...
		ServiceConfig(final org.eclipse.jgit.transport.DaemonService service, final Config cfg,
		              final String name) {
