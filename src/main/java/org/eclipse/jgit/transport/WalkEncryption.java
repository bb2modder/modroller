...
abstract class WalkEncryption {
	static final org.eclipse.jgit.transport.WalkEncryption NONE = new NoEncryption();
	...
	private static class NoEncryption extends org.eclipse.jgit.transport.WalkEncryption {
		@Override
	 ...
	 */
	static class JetS3tV2 extends org.eclipse.jgit.transport.WalkEncryption {
	 ...
	 * format.
	 */
	abstract static class SymmetricEncryption extends org.eclipse.jgit.transport.WalkEncryption
	...
	static class JGitV1 extends SymmetricEncryption {
		...
		static Properties wrap(String algo, String pass) {
			...
			props.put(algo + X_ALGO, algo);
			props.put(algo + X_KEY_ALGO, algo);
			props.put(algo + X_KEY_ITER, DEFAULT_KEY_ITER);
			props.put(algo + X_KEY_SIZE, DEFAULT_KEY_SIZE);
			props.put(algo + X_KEY_SALT, DEFAULT_KEY_SALT);
			return props;
		}
	 ...
	 * @throws GeneralSecurityException
	 */
	static org.eclipse.jgit.transport.WalkEncryption instance(Properties props)
			throws GeneralSecurityException {
