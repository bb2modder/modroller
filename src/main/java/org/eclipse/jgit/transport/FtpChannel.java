...
public interface FtpChannel {
	...
	/**
	 * Connects the {@link org.eclipse.jgit.transport.FtpChannel} to the remote end.
	 *
	 * @param timeout
	...
	/**
	 * Disconnects and {@link org.eclipse.jgit.transport.FtpChannel}.
	 */
	void disconnect();

	/**
	 * @return whether the {@link org.eclipse.jgit.transport.FtpChannel} is connected
	 */
	boolean isConnected();
