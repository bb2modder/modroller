 ...
 * @since 5.1
 */
public final class FetchV2Request extends org.eclipse.jgit.transport.FetchRequest {
	...
	/** @return A builder of {@link org.eclipse.jgit.transport.FetchV2Request}. */
	static Builder builder() {
		return new Builder();
	}

	/** A builder for {@link org.eclipse.jgit.transport.FetchV2Request}. */
	static final class Builder {
		 ...
		 * {@link org.eclipse.jgit.transport.FetchV2Request#getServerOptions}.
		 *
		 * @param value
		 ...
		 */
		org.eclipse.jgit.transport.FetchV2Request build() {
			return new org.eclipse.jgit.transport.FetchV2Request(peerHas, wantedRefs, wantIds,
