...
public class ReceivedPackStatistics {
	...
	/** A builder for {@link org.eclipse.jgit.transport.ReceivedPackStatistics}. */
	public static class Builder {
		...
		org.eclipse.jgit.transport.ReceivedPackStatistics build() {
			org.eclipse.jgit.transport.ReceivedPackStatistics s = new org.eclipse.jgit.transport.ReceivedPackStatistics();
