...
public abstract class SshSessionFactory {
	 ...
	 */
	public static org.eclipse.jgit.transport.SshSessionFactory getInstance() {
		return INSTANCE;
	}
	 ...
	 */
	public static void setInstance(org.eclipse.jgit.transport.SshSessionFactory newFactory) {
		if (newFactory != null) {
			INSTANCE = newFactory;
		} else {
