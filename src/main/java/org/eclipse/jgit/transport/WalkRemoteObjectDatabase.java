...
abstract class WalkRemoteObjectDatabase {
	 ...
	 */
	abstract Collection<org.eclipse.jgit.transport.WalkRemoteObjectDatabase> getAlternates()
			throws IOException;
	 ...
	 *             verify that.
	 */
	abstract org.eclipse.jgit.transport.WalkRemoteObjectDatabase openAlternate(String location)
			throws IOException;
	 ...
	 *             stream could be created.
	 */
	Collection<org.eclipse.jgit.transport.WalkRemoteObjectDatabase> readAlternates(final String listPath)
			throws IOException {
		try (BufferedReader br = openReader(listPath)) {
			final Collection<org.eclipse.jgit.transport.WalkRemoteObjectDatabase> alts = new ArrayList<>();
			for (;;) {
