...
public class LfsFactory {
	...
	private static org.eclipse.jgit.util.LfsFactory instance = new org.eclipse.jgit.util.LfsFactory();
	...
	/**
	 * @param instance
	 *            register a {@link org.eclipse.jgit.util.LfsFactory} instance as the
	 *            {@link org.eclipse.jgit.util.LfsFactory} implementation to use.
	 */
	public static void setInstance(org.eclipse.jgit.util.LfsFactory instance) {
		org.eclipse.jgit.util.LfsFactory.instance = instance;
	}
