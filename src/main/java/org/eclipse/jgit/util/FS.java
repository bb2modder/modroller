...
public abstract class FS {
	...
	public static class FSFactory {
		 ...
		 * @return FS instance
		 */
		public org.eclipse.jgit.util.FS detect(Boolean cygwinUsed) {
	...
	public static final org.eclipse.jgit.util.FS DETECTED = detect();
	 ...
	 * @return detected file system abstraction
	 */
	public static org.eclipse.jgit.util.FS detect(Boolean cygwinUsed) {
		if (factory == null) {
			factory = new org.eclipse.jgit.util.FS.FSFactory();
		}
	 ...
	 */
	protected FS(org.eclipse.jgit.util.FS src) {
	 ...
	 * @return {@code this}.
	 */
	public org.eclipse.jgit.util.FS setUserHome(File path) {
	...
	protected File discoverGitSystemConfig() {
		...
		if (StringUtils.isEmptyOrNull(v)
				|| (v != null && v.startsWith("org/eclipse/jgit"))) { //$NON-NLS-1$
			return null;
		}
	 ...
	 * @since 4.0
	 */
	public org.eclipse.jgit.util.FS setGitSystemConfig(File configFile) {
	...
	public File findHook(Repository repository, String hookName) {
		...
		if (hookFile.isAbsolute()) {
			if (!hookFile.exists() || (DETECTED.supportsExecute()
					&& !DETECTED.canExecute(hookFile))) {
				return null;
			}
		} else {
			try {
	...
	public static class Attributes {
		...
		Attributes(org.eclipse.jgit.util.FS fs, File file, boolean exists, boolean isDirectory,
		 ...
		 * @param path
		 */
		public Attributes(File path, org.eclipse.jgit.util.FS fs) {
