...
public abstract class QuotedString {
	 ...
	 * @since 5.6
	 */
	public static final org.eclipse.jgit.util.QuotedString GIT_PATH_MINIMAL = new GitPathStyle(false);
	 ...
	 * being recognized as special.
	 */
	public static class BourneStyle extends org.eclipse.jgit.util.QuotedString {
		@Override
	...
	/** Quoting style that obeys the rules Git applies to file names */
	public static final class GitPathStyle extends org.eclipse.jgit.util.QuotedString {
