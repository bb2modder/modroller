...
public abstract class TemporaryBuffer extends OutputStream {
	 ...
	 */
	public static class LocalFile extends org.eclipse.jgit.util.TemporaryBuffer {
		...
		public void writeTo(OutputStream os, ProgressMonitor pm)
			...
			try (FileInputStream in = new FileInputStream(onDiskFile)) {
				int cnt;
				final byte[] buf = new byte[org.eclipse.jgit.util.TemporaryBuffer.Block.SZ];
	 ...
	 */
	public static class Heap extends org.eclipse.jgit.util.TemporaryBuffer {
		/**
