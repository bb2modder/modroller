...
public final class RawCharSequence implements CharSequence {
	...
	public static final org.eclipse.jgit.util.RawCharSequence EMPTY = new org.eclipse.jgit.util.RawCharSequence(null, 0, 0);
	...
	public CharSequence subSequence(int start, int end) {
		return new org.eclipse.jgit.util.RawCharSequence(buffer, startPtr + start, startPtr + end);
	}
