...
public class AutoLFInputStream extends InputStream {
	...
	/**
	 * A special exception thrown when {@link org.eclipse.jgit.util.io.AutoLFInputStream} is told to
	...
	/**
	 * Factory method for creating an {@link org.eclipse.jgit.util.io.AutoLFInputStream} with the
	 ...
	 * @return a new {@link org.eclipse.jgit.util.io.AutoLFInputStream}
	 * @since 5.9
	 */
	public static org.eclipse.jgit.util.io.AutoLFInputStream create(InputStream in,
	                                                                StreamFlag... flags) {
		if (flags == null) {
			return new org.eclipse.jgit.util.io.AutoLFInputStream(in, null);
		}
		EnumSet<StreamFlag> set = EnumSet.noneOf(StreamFlag.class);
		set.addAll(Arrays.asList(flags));
		return new org.eclipse.jgit.util.io.AutoLFInputStream(in, set);
	}
