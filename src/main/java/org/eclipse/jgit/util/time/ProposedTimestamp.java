...
public abstract class ProposedTimestamp implements AutoCloseable {
	 ...
	 */
	public static void blockUntil(Iterable<org.eclipse.jgit.util.time.ProposedTimestamp> times,
			Duration maxWait) throws TimeoutException, InterruptedException {
		Iterator<org.eclipse.jgit.util.time.ProposedTimestamp> itr = times.iterator();
		if (!itr.hasNext()) {
			return;
		}
