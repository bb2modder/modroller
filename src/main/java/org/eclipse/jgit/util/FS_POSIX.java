...
public class FS_POSIX extends FS {
	...
	protected FS_POSIX(FS src) {
		super(src);
		if (src instanceof org.eclipse.jgit.util.FS_POSIX) {
			umask = ((org.eclipse.jgit.util.FS_POSIX) src).umask;
		}
	}
	...
	public FS newInstance() {
		return new org.eclipse.jgit.util.FS_POSIX(this);
	}
	 ...
	 *
	 * @deprecated use {@link org.eclipse.jgit.util.FS_POSIX#createNewFileAtomic(File)} instead
	 * @since 4.5
	 */
	@Deprecated
