...
final class NoteParser extends CanonicalTreeParser {
	 ...
	 */
	static org.eclipse.jgit.notes.InMemoryNoteBucket parse(AbbreviatedObjectId prefix,
	                                                       final ObjectId treeId, final ObjectReader reader)
			throws IOException {
		return new org.eclipse.jgit.notes.NoteParser(prefix, reader, treeId).parse();
	}
	...
	private org.eclipse.jgit.notes.InMemoryNoteBucket parse() {
		org.eclipse.jgit.notes.InMemoryNoteBucket r = parseTree();
	...
	private org.eclipse.jgit.notes.InMemoryNoteBucket parseTree() {
		...
		return new org.eclipse.jgit.notes.LeafBucket(prefixLen);
	}

	private org.eclipse.jgit.notes.LeafBucket parseLeafTree() {
		final org.eclipse.jgit.notes.LeafBucket leaf = new org.eclipse.jgit.notes.LeafBucket(prefixLen);
	...
	private void storeNonNote() {
		...
		org.eclipse.jgit.notes.NonNoteEntry ent = new org.eclipse.jgit.notes.NonNoteEntry(name, fileMode, id);
