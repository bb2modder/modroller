 ...
 * {@link ObjectReader} that it borrows/shares with the
...
public class NoteMap implements Iterable<Note> {
	...
	public static org.eclipse.jgit.notes.NoteMap newEmptyMap() {
		org.eclipse.jgit.notes.NoteMap r = new org.eclipse.jgit.notes.NoteMap(null /* no reader */);
	 ...
	 * {@link Constants#R_NOTES} prefix if it exists.
	 *
	 * @param noteRefName
	 ...
	 */
	public static org.eclipse.jgit.notes.NoteMap read(ObjectReader reader, RevCommit commit)
	 ...
	 *             a reference tree object doesn't exist.
	 */
	public static org.eclipse.jgit.notes.NoteMap read(ObjectReader reader, RevTree tree)
			throws MissingObjectException, IncorrectObjectTypeException,
			CorruptObjectException, IOException {
	 ...
	 *             a reference tree object doesn't exist.
	 */
	public static org.eclipse.jgit.notes.NoteMap readTree(ObjectReader reader, ObjectId treeId)
			throws MissingObjectException, IncorrectObjectTypeException,
			CorruptObjectException, IOException {
		org.eclipse.jgit.notes.NoteMap map = new org.eclipse.jgit.notes.NoteMap(reader);
		map.load(treeId);
		return map;
	}
	 ...
	 */
	static org.eclipse.jgit.notes.NoteMap newMap(InMemoryNoteBucket root, ObjectReader reader) {
		org.eclipse.jgit.notes.NoteMap map = new org.eclipse.jgit.notes.NoteMap(reader);
		map.root = root;
		return map;
	}
