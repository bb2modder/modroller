...
public class NLS {
	...
	private static final InheritableThreadLocal<org.eclipse.jgit.nls.NLS> local = new InheritableThreadLocal<>();
	...
	public static void setLocale(Locale locale) {
		local.set(new org.eclipse.jgit.nls.NLS(locale));
	}
	...
	private static org.eclipse.jgit.nls.NLS useJVMDefaultInternal() {
		org.eclipse.jgit.nls.NLS b = new org.eclipse.jgit.nls.NLS(Locale.getDefault());
		local.set(b);
		return b;
	}
	...
	public static <T extends TranslationBundle> T getBundleFor(Class<T> type) {
		org.eclipse.jgit.nls.NLS b = local.get();
		if (b == null) {
