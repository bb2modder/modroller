...
public class MergeConfig {
	 ...
	 */
	public static org.eclipse.jgit.merge.MergeConfig getConfigForCurrentBranch(Repository repo) {
		try {
		...
		return new org.eclipse.jgit.merge.MergeConfig();
	}
	 ...
	 *         {@link Config#get(SectionParser)}
	 */
	public static final SectionParser<org.eclipse.jgit.merge.MergeConfig> getParser(
			final String branch) {
	...
	private static class MergeConfigSectionParser implements
			SectionParser<org.eclipse.jgit.merge.MergeConfig> {
		...
		@Override
		public org.eclipse.jgit.merge.MergeConfig parse(Config cfg) {
			return new org.eclipse.jgit.merge.MergeConfig(branch, cfg);
		}
