...
public abstract class MergeStrategy {
	...
	public static final org.eclipse.jgit.merge.MergeStrategy OURS = new StrategyOneSided("ours", 0); //$NON-NLS-1$

	/** Simple strategy that sets the output tree to the second input tree. */
	public static final org.eclipse.jgit.merge.MergeStrategy THEIRS = new StrategyOneSided("theirs", 1); //$NON-NLS-1$
	...
	private static final HashMap<String, org.eclipse.jgit.merge.MergeStrategy> STRATEGIES = new HashMap<>();
	 ...
	 */
	public static void register(org.eclipse.jgit.merge.MergeStrategy imp) {
	...
	public static synchronized void register(final String name,
			final org.eclipse.jgit.merge.MergeStrategy imp) {
	 ...
	 */
	public static synchronized org.eclipse.jgit.merge.MergeStrategy get(String name) {
	 ...
	 */
	public static synchronized org.eclipse.jgit.merge.MergeStrategy[] get() {
		final org.eclipse.jgit.merge.MergeStrategy[] r = new org.eclipse.jgit.merge.MergeStrategy[STRATEGIES.size()];
