 ...
 * @since 4.0
 */
public class CommitMsgHook extends org.eclipse.jgit.hooks.GitHook<String> {
	 ...
	 */
	public org.eclipse.jgit.hooks.CommitMsgHook setCommitMessage(String commitMessage) {
