...
public class IndexDiff {
	 ...
	 *
	 * @see org.eclipse.jgit.lib.IndexDiff#getConflictingStageStates()
	 * @since 3.0
	 */
	...
	private Map<String, org.eclipse.jgit.lib.IndexDiff> submoduleIndexDiffs = new HashMap<>();
					...
					try (Repository subRepo = smw.getRepository()) {
						...
						if (subRepo != null) {
							...
							if (subHead != null
								...
								org.eclipse.jgit.lib.IndexDiff smid = submoduleIndexDiffs
										.get(smw.getPath());
								if (smid == null) {
									smid = new org.eclipse.jgit.lib.IndexDiff(subRepo,
											smw.getObjectId(),
