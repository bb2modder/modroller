...
public interface BlobObjectChecker {
	/** No-op implementation of {@link org.eclipse.jgit.lib.BlobObjectChecker}. */
	org.eclipse.jgit.lib.BlobObjectChecker NULL_CHECKER =
			new org.eclipse.jgit.lib.BlobObjectChecker() {
				@Override
