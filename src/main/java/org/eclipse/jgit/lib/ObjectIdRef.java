...
public abstract class ObjectIdRef implements Ref {
	...
	public static class Unpeeled extends org.eclipse.jgit.lib.ObjectIdRef {
		/**
	...
	public static class PeeledTag extends org.eclipse.jgit.lib.ObjectIdRef {
	...
	public static class PeeledNonTag extends org.eclipse.jgit.lib.ObjectIdRef {
		/**
		 * Create a new ref pairing.
		 *
		 * @param st
