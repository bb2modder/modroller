...
public abstract class ObjectInserter implements AutoCloseable {
	...
	public static class Formatter extends org.eclipse.jgit.lib.ObjectInserter {
		@Override
	...
	public abstract static class Filter extends org.eclipse.jgit.lib.ObjectInserter {
		...
		public ObjectReader newReader() {
			...
			return new ObjectReader.Filter() {
				...
				public org.eclipse.jgit.lib.ObjectInserter getCreatedFromInserter() {
					return org.eclipse.jgit.lib.ObjectInserter.Filter.this;
				}
			};
		}
