...
public class BatchRefUpdate {
	 ...
	 * @return {@code this}.
	 */
	public org.eclipse.jgit.lib.BatchRefUpdate setAllowNonFastForwards(boolean allow) {
	 ...
	 * @return {@code this}.
	 */
	public org.eclipse.jgit.lib.BatchRefUpdate setRefLogIdent(PersonIdent pi) {
		refLogIdent = pi;
		return this;
	}
	 ...
	 * @return {@code this}.
	 */
	public org.eclipse.jgit.lib.BatchRefUpdate setRefLogMessage(String msg, boolean appendStatus) {
	 ...
	 * @since 4.9
	 */
	public org.eclipse.jgit.lib.BatchRefUpdate setForceRefLog(boolean force) {
		forceRefLog = force;
		return this;
	}
	 ...
	 * @since 4.4
	 */
	public org.eclipse.jgit.lib.BatchRefUpdate setAtomic(boolean atomic) {
		this.atomic = atomic;
		return this;
	}
	 ...
	 * @return {@code this}.
	 */
	public org.eclipse.jgit.lib.BatchRefUpdate addCommand(ReceiveCommand cmd) {
		commands.add(cmd);
		return this;
	}
	 ...
	 * @return {@code this}.
	 */
	public org.eclipse.jgit.lib.BatchRefUpdate addCommand(Collection<ReceiveCommand> cmd) {
		commands.addAll(cmd);
		return this;
	}
	 ...
	 * @since 4.6
	 */
	public org.eclipse.jgit.lib.BatchRefUpdate addProposedTimestamp(ProposedTimestamp ts) {
		if (timestamps == null) {
