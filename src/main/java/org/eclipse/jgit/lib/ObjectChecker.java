...
public class ObjectChecker {
	 ...
	 * @since 4.2
	 */
	public org.eclipse.jgit.lib.ObjectChecker setSkipList(@Nullable ObjectIdSet objects) {
		skipList = objects;
		return this;
	}
	 ...
	 * @since 4.2
	 */
	public org.eclipse.jgit.lib.ObjectChecker setIgnore(@Nullable Set<ErrorType> ids) {
	 ...
	 * @since 4.2
	 */
	public org.eclipse.jgit.lib.ObjectChecker setIgnore(ErrorType id, boolean ignore) {
		if (ignore) {
			errors.remove(id);
		} else {
			errors.add(id);
	 ...
	 * @since 3.4
	 */
	public org.eclipse.jgit.lib.ObjectChecker setAllowLeadingZeroFileMode(boolean allow) {
	 ...
	 * @since 4.0
	 */
	public org.eclipse.jgit.lib.ObjectChecker setAllowInvalidPersonIdent(boolean allow) {
	 ...
	 * @since 3.4
	 */
	public org.eclipse.jgit.lib.ObjectChecker setSafeForWindows(boolean win) {
		windows = win;
		return this;
	}
	 ...
	 * @since 3.4
	 */
	public org.eclipse.jgit.lib.ObjectChecker setSafeForMacOS(boolean mac) {
		macosx = mac;
		return this;
	}
