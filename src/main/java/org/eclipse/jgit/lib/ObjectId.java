...
public class ObjectId extends AnyObjectId implements Serializable {
	...
	static {
		ZEROID = new org.eclipse.jgit.lib.ObjectId(0, 0, 0, 0, 0);
	 ...
	 */
	public static final String toString(org.eclipse.jgit.lib.ObjectId i) {
	 ...
	 */
	public static final org.eclipse.jgit.lib.ObjectId fromRaw(byte[] bs) {
		return fromRaw(bs, 0);
	}
	 ...
	 * @return the converted object id.
	 */
	public static final org.eclipse.jgit.lib.ObjectId fromRaw(byte[] bs, int p) {
		...
		return new org.eclipse.jgit.lib.ObjectId(a, b, c, d, e);
	}
	 ...
	 * @return the converted object id.
	 */
	public static final org.eclipse.jgit.lib.ObjectId fromRaw(int[] is) {
		return fromRaw(is, 0);
	}
	 ...
	 * @return the converted object id.
	 */
	public static final org.eclipse.jgit.lib.ObjectId fromRaw(int[] is, int p) {
		return new org.eclipse.jgit.lib.ObjectId(is[p], is[p + 1], is[p + 2], is[p + 3], is[p + 4]);
	}
	 ...
	 * @return the converted object id.
	 */
	public static final org.eclipse.jgit.lib.ObjectId fromString(byte[] buf, int offset) {
	 ...
	 * @return the converted object id.
	 */
	public static org.eclipse.jgit.lib.ObjectId fromString(String str) {
	...
	private static final org.eclipse.jgit.lib.ObjectId fromHexString(byte[] bs, int p) {
		try {
