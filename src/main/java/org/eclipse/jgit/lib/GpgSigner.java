...
public abstract class GpgSigner {
	...
	private static org.eclipse.jgit.lib.GpgSigner defaultSigner = loadGpgSigner();

	private static org.eclipse.jgit.lib.GpgSigner loadGpgSigner() {
		try {
			ServiceLoader<org.eclipse.jgit.lib.GpgSigner> loader = ServiceLoader
					.load(org.eclipse.jgit.lib.GpgSigner.class);
			Iterator<org.eclipse.jgit.lib.GpgSigner> iter = loader.iterator();
			if (iter.hasNext()) {
				return iter.next();
			}
	 ...
	 *            default.
	 */
	public static void setDefault(org.eclipse.jgit.lib.GpgSigner signer) {
