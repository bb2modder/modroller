...
import static org.eclipse.jgit.util.RawCharUtil.*;
...
public abstract class RawTextComparator extends SequenceComparator<RawText> {
	...
	public static final org.eclipse.jgit.diff.RawTextComparator DEFAULT = new org.eclipse.jgit.diff.RawTextComparator() {
		@Override
	...
	public static final org.eclipse.jgit.diff.RawTextComparator WS_IGNORE_ALL = new org.eclipse.jgit.diff.RawTextComparator() {
		@Override
		public boolean equals(RawText a, int ai, RawText b, int bi) {
			ai++;
			bi++;
	 ...
	 **/
	public static final org.eclipse.jgit.diff.RawTextComparator WS_IGNORE_LEADING = new org.eclipse.jgit.diff.RawTextComparator() {
		@Override
		public boolean equals(RawText a, int ai, RawText b, int bi) {
			ai++;
			bi++;
	...
	public static final org.eclipse.jgit.diff.RawTextComparator WS_IGNORE_TRAILING = new org.eclipse.jgit.diff.RawTextComparator() {
		@Override
		public boolean equals(RawText a, int ai, RawText b, int bi) {
			ai++;
			bi++;
	...
	public static final org.eclipse.jgit.diff.RawTextComparator WS_IGNORE_CHANGE = new org.eclipse.jgit.diff.RawTextComparator() {
		@Override
		public boolean equals(RawText a, int ai, RawText b, int bi) {
			ai++;
			bi++;
