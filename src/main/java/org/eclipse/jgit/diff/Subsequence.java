...
public final class Subsequence<S extends Sequence> extends Sequence {
	 ...
	 */
	public static <S extends Sequence> org.eclipse.jgit.diff.Subsequence<S> a(S a, Edit region) {
		return new org.eclipse.jgit.diff.Subsequence<>(a, region.beginA, region.endA);
	}
	 ...
	 */
	public static <S extends Sequence> org.eclipse.jgit.diff.Subsequence<S> b(S b, Edit region) {
		return new org.eclipse.jgit.diff.Subsequence<>(b, region.beginB, region.endB);
	}
	 ...
	 *            the B sequence.
	 */
	public static <S extends Sequence> void toBase(Edit e, org.eclipse.jgit.diff.Subsequence<S> a,
			org.eclipse.jgit.diff.Subsequence<S> b) {
		e.beginA += a.begin;
		e.endA += a.begin;
	...
	public static <S extends Sequence> EditList toBase(EditList edits,
	                                                   org.eclipse.jgit.diff.Subsequence<S> a, org.eclipse.jgit.diff.Subsequence<S> b) {
		for (Edit e : edits)
			toBase(e, a, b);
		return edits;
	}
