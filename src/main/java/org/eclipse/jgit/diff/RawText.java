...
public class RawText extends Sequence {
	...
	public static final org.eclipse.jgit.diff.RawText EMPTY_TEXT = new org.eclipse.jgit.diff.RawText(new byte[0]);
	 ...
	 */
	public static org.eclipse.jgit.diff.RawText load(ObjectLoader ldr, int threshold)
		...
		if (sz <= FIRST_FEW_BYTES) {
			...
			return new org.eclipse.jgit.diff.RawText(data);
		}
		...
		try (InputStream stream = ldr.openStream()) {
			...
			return new org.eclipse.jgit.diff.RawText(data, RawParseUtils.lineMapOrBinary(data, 0, (int) sz));
		}
	}
}
