...
public class DiffEntry {
	 ...
	 */
	public static List<org.eclipse.jgit.diff.DiffEntry> scan(TreeWalk walk) throws IOException {
	 ...
	 *             trees
	 */
	public static List<org.eclipse.jgit.diff.DiffEntry> scan(TreeWalk walk, boolean includeTrees)
			throws IOException {
	...
	public static List<org.eclipse.jgit.diff.DiffEntry> scan(TreeWalk walk, boolean includeTrees,
		...
		List<org.eclipse.jgit.diff.DiffEntry> r = new ArrayList<>();
		MutableObjectId idBuf = new MutableObjectId();
		while (walk.next()) {
			org.eclipse.jgit.diff.DiffEntry entry = new org.eclipse.jgit.diff.DiffEntry();
	...
	static org.eclipse.jgit.diff.DiffEntry add(String path, AnyObjectId id) {
		org.eclipse.jgit.diff.DiffEntry e = new org.eclipse.jgit.diff.DiffEntry();
		e.oldId = A_ZERO;
	...
	static org.eclipse.jgit.diff.DiffEntry delete(String path, AnyObjectId id) {
		org.eclipse.jgit.diff.DiffEntry e = new org.eclipse.jgit.diff.DiffEntry();
	...
	static org.eclipse.jgit.diff.DiffEntry modify(String path) {
		org.eclipse.jgit.diff.DiffEntry e = new org.eclipse.jgit.diff.DiffEntry();
		e.oldMode = FileMode.REGULAR_FILE;
		e.oldPath = path;
	 ...
	 */
	static List<org.eclipse.jgit.diff.DiffEntry> breakModify(org.eclipse.jgit.diff.DiffEntry entry) {
		org.eclipse.jgit.diff.DiffEntry del = new org.eclipse.jgit.diff.DiffEntry();
		...
		org.eclipse.jgit.diff.DiffEntry add = new org.eclipse.jgit.diff.DiffEntry();
		add.oldId = A_ZERO;
	...
	static org.eclipse.jgit.diff.DiffEntry pair(ChangeType changeType, org.eclipse.jgit.diff.DiffEntry src, org.eclipse.jgit.diff.DiffEntry dst,
	                                            int score) {
		org.eclipse.jgit.diff.DiffEntry r = new org.eclipse.jgit.diff.DiffEntry();
