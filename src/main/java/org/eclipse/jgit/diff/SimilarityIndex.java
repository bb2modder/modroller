...
public class SimilarityIndex {
	 ...
	 *             SimilarityIndex.
	 */
	public static org.eclipse.jgit.diff.SimilarityIndex create(ObjectLoader obj) throws IOException,
			TableFullException {
		org.eclipse.jgit.diff.SimilarityIndex idx = new org.eclipse.jgit.diff.SimilarityIndex();
		idx.hash(obj);
		idx.sort();
		return idx;
	}
	 ...
	 */
	public int score(org.eclipse.jgit.diff.SimilarityIndex dst, int maxScore) {
	...
	long common(org.eclipse.jgit.diff.SimilarityIndex dst) {
		return common(this, dst);
	}

	private static long common(org.eclipse.jgit.diff.SimilarityIndex src, org.eclipse.jgit.diff.SimilarityIndex dst) {
