...
public class FileTreeIterator extends WorkingTreeIterator {
	 ...
	 * @since 4.3
	 */
	protected FileTreeIterator(final org.eclipse.jgit.treewalk.FileTreeIterator p, final File root,
	                           FS fs) {
	...
	protected AbstractTreeIterator enterSubtree() {
		return new org.eclipse.jgit.treewalk.FileTreeIterator(this, ((FileEntry) current()).getFile(), fs,
				fileModeStrategy);
	}
