 ...
 * iterator, {@link FileTreeIterator}, as that does
...
public abstract class WorkingTreeIterator extends AbstractTreeIterator {
	 ...
	 */
	protected WorkingTreeIterator(org.eclipse.jgit.treewalk.WorkingTreeIterator p) {
		super(p);
		state = p.state;
	...
	/**
	 * Define the matching {@link DirCacheIterator},
	...
	/**
	 * Defines whether this {@link org.eclipse.jgit.treewalk.WorkingTreeIterator} walks ignored
	 * directories.
	 *
	...
	/**
	 * Tells whether this {@link org.eclipse.jgit.treewalk.WorkingTreeIterator} walks ignored directories.
	 *
	...
	private InputStream filterClean(InputStream in, OperationType opType)
		...
		if (filterCommand != null) {
			if (FilterCommandRegistry.isRegistered(filterCommand)) {
				LocalFile buffer = new LocalFile(null);
	...
	/**
	 * Retrieves the {@link Repository} this {@link org.eclipse.jgit.treewalk.WorkingTreeIterator}
	 * operates on.
	 *
	...
	private boolean isEntryIgnored(int pLen, int fileMode)
		...
		return parent instanceof org.eclipse.jgit.treewalk.WorkingTreeIterator
				&& ((org.eclipse.jgit.treewalk.WorkingTreeIterator) parent).isEntryIgnored(pLen,
						fileMode);
	}
	 ...
	 * current entry.
	 *
	 * @return the {@link AttributesNode} for the
	 *         current entry.
	 * @throws IOException
	 */
	 ...
	 *
	 * @param entry
	 *            the {@link DirCacheEntry} to compare
	 *            with
	 * @return a
	 ...
	 *
	 * @param indexIter
	 *            {@link DirCacheIterator} positioned
	 *            at the same entry as this iterator or null if no
	 *            {@link DirCacheIterator} is
	 ...
	 *         {@link TreeWalk} is not based on a
	 *         {@link Repository} then null is returned.
	 * @throws IOException
	 * @since 4.3
	 */
	...
	private boolean isDirectoryIgnored(String pathRel, String pathAbs)
		...
		if (!(this.parent instanceof org.eclipse.jgit.treewalk.WorkingTreeIterator)) {
			state.directoryToIgnored.put(pathAbs, Boolean.FALSE);
			return false;
		}

		final org.eclipse.jgit.treewalk.WorkingTreeIterator wtParent = (org.eclipse.jgit.treewalk.WorkingTreeIterator) this.parent;
