...
public abstract class OrTreeFilter extends TreeFilter {
	...
	private static class Binary extends org.eclipse.jgit.treewalk.filter.OrTreeFilter {
	...
	private static class List extends org.eclipse.jgit.treewalk.filter.OrTreeFilter {
