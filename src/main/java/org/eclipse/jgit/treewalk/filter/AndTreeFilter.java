...
public abstract class AndTreeFilter extends TreeFilter {
	...
	private static class Binary extends org.eclipse.jgit.treewalk.filter.AndTreeFilter {
	...
	private static class List extends org.eclipse.jgit.treewalk.filter.AndTreeFilter {
