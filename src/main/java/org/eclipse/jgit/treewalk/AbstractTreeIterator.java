...
public abstract class AbstractTreeIterator {
	 ...
	 * @since 4.3
	 */
	public final org.eclipse.jgit.treewalk.AbstractTreeIterator parent;

	/** The iterator this current entry is path equal to. */
	org.eclipse.jgit.treewalk.AbstractTreeIterator matches;
	 ...
	 */
	protected AbstractTreeIterator(org.eclipse.jgit.treewalk.AbstractTreeIterator p) {
		parent = p;
		path = p.path;
	 ...
	 */
	protected AbstractTreeIterator(final org.eclipse.jgit.treewalk.AbstractTreeIterator p,
	...
	private void setPathCapacity(int capacity, int len) {
		...
		for (org.eclipse.jgit.treewalk.AbstractTreeIterator p = this; p != null && p.path == o; p = p.parent)
			p.path = n;
	}
	 ...
	 */
	public int pathCompare(org.eclipse.jgit.treewalk.AbstractTreeIterator p) {
		return pathCompare(p, p.mode);
	}

	int pathCompare(org.eclipse.jgit.treewalk.AbstractTreeIterator p, int pMode) {
	...
	private static int alreadyMatch(org.eclipse.jgit.treewalk.AbstractTreeIterator a,
	                                org.eclipse.jgit.treewalk.AbstractTreeIterator b) {
		for (;;) {
			final org.eclipse.jgit.treewalk.AbstractTreeIterator ap = a.parent;
			final org.eclipse.jgit.treewalk.AbstractTreeIterator bp = b.parent;
			if (ap == null || bp == null)
				return 0;
	 ...
	 */
	public boolean idEqual(org.eclipse.jgit.treewalk.AbstractTreeIterator otherIterator) {
	 ...
	 */
	public abstract org.eclipse.jgit.treewalk.AbstractTreeIterator createSubtreeIterator(
	 ...
	 *             a loose object or pack file could not be read.
	 */
	public org.eclipse.jgit.treewalk.AbstractTreeIterator createSubtreeIterator(
