...
public class CanonicalTreeParser extends AbstractTreeIterator {
	...
	private CanonicalTreeParser(org.eclipse.jgit.treewalk.CanonicalTreeParser p) {
		super(p);
	}
	...
	public org.eclipse.jgit.treewalk.CanonicalTreeParser getParent() {
		return (org.eclipse.jgit.treewalk.CanonicalTreeParser) parent;
	}
	 ...
	 *             a loose object or pack file could not be read.
	 */
	public org.eclipse.jgit.treewalk.CanonicalTreeParser resetRoot(final ObjectReader reader,
	                                                               final AnyObjectId id) throws IncorrectObjectTypeException,
			IOException {
		org.eclipse.jgit.treewalk.CanonicalTreeParser p = this;
		while (p.parent != null)
			p = (org.eclipse.jgit.treewalk.CanonicalTreeParser) p.parent;
		p.reset(reader, id);
		return p;
	}
	...
	/** {@inheritDoc} */
	@Override
	public org.eclipse.jgit.treewalk.CanonicalTreeParser createSubtreeIterator(final ObjectReader reader,
	 ...
	 *             a loose object or pack file could not be read.
	 */
	public final org.eclipse.jgit.treewalk.CanonicalTreeParser createSubtreeIterator0(
			final ObjectReader reader, final AnyObjectId id)
			throws IOException {
		final org.eclipse.jgit.treewalk.CanonicalTreeParser p = new org.eclipse.jgit.treewalk.CanonicalTreeParser(this);
		p.reset(reader, id);
		return p;
	}
	...
	/** {@inheritDoc} */
	@Override
	public org.eclipse.jgit.treewalk.CanonicalTreeParser createSubtreeIterator(ObjectReader reader)
			throws IncorrectObjectTypeException, IOException {
	...
	private AttributesNode findAttributes(ObjectReader reader)
			throws IOException {
		org.eclipse.jgit.treewalk.CanonicalTreeParser itr = new org.eclipse.jgit.treewalk.CanonicalTreeParser();
		itr.reset(raw);
