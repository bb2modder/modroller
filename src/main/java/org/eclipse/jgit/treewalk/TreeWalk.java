...
public class TreeWalk implements AutoCloseable, AttributesProvider {
	 ...
	 */
	public static org.eclipse.jgit.treewalk.TreeWalk forPath(final ObjectReader reader, final String path,
	 ...
	 * @since 4.3
	 */
	public static org.eclipse.jgit.treewalk.TreeWalk forPath(final @Nullable Repository repo,
	                                                         final ObjectReader reader, final String path,
	                                                         final AnyObjectId... trees)
					throws MissingObjectException, IncorrectObjectTypeException,
					CorruptObjectException, IOException {
		org.eclipse.jgit.treewalk.TreeWalk tw = new org.eclipse.jgit.treewalk.TreeWalk(repo, reader);
	 ...
	 *             a tree object was not found.
	 */
	public static org.eclipse.jgit.treewalk.TreeWalk forPath(final Repository db, final String path,
	                                                         final AnyObjectId... trees) throws MissingObjectException,
			IncorrectObjectTypeException, CorruptObjectException, IOException {
	 ...
	 * {@link org.eclipse.jgit.treewalk.TreeWalk} requires to have at least one
