 ...
 * @since 4.0
 */
public class RepoProject implements Comparable<org.eclipse.jgit.gitrepo.RepoProject> {
	 ...
	 */
	public org.eclipse.jgit.gitrepo.RepoProject setUrl(String url) {
		this.url = url;
		return this;
	}
	 ...
	 * @since 4.4
	 */
	public org.eclipse.jgit.gitrepo.RepoProject setGroups(String groupsParam) {
		this.groups.clear();
	 ...
	 * @return this for chaining.
	 */
	public org.eclipse.jgit.gitrepo.RepoProject setDefaultRevision(String defaultRevision) {
	 ...
	 */
	public boolean isAncestorOf(org.eclipse.jgit.gitrepo.RepoProject that) {
	...
	public boolean equals(Object o) {
		if (o instanceof org.eclipse.jgit.gitrepo.RepoProject) {
			org.eclipse.jgit.gitrepo.RepoProject that = (org.eclipse.jgit.gitrepo.RepoProject) o;
	...
	/** {@inheritDoc} */
	@Override
	public int compareTo(org.eclipse.jgit.gitrepo.RepoProject that) {
