...
public class RevFlagSet extends AbstractSet<RevFlag> {
	 ...
	 */
	public RevFlagSet(org.eclipse.jgit.revwalk.RevFlagSet s) {
		mask = s.mask;
	...
	public boolean containsAll(Collection<?> c) {
		if (c instanceof org.eclipse.jgit.revwalk.RevFlagSet) {
			final int cMask = ((org.eclipse.jgit.revwalk.RevFlagSet) c).mask;
