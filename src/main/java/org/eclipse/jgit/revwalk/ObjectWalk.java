...
public class ObjectWalk extends RevWalk {
	 ...
	 * by {@link org.eclipse.jgit.revwalk.ObjectWalk#nextObject()}) again. However, this behavior can be
	...
	public ObjectWalk(ObjectReader or) {
		...
		pendingObjects = new org.eclipse.jgit.revwalk.BlockObjQueue();
	...
	public ObjectReachabilityChecker createObjectReachabilityChecker()
		...
		if (reader.getBitmapIndex() != null) {
			return new org.eclipse.jgit.revwalk.BitmappedObjectReachabilityChecker(this);
		}

		return new org.eclipse.jgit.revwalk.PedestrianObjectReachabilityChecker(this);
	}
