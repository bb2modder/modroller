...
public abstract class AndRevFilter extends RevFilter {
	...
	private static class Binary extends org.eclipse.jgit.revwalk.filter.AndRevFilter {
	...
	private static class List extends org.eclipse.jgit.revwalk.filter.AndRevFilter {
