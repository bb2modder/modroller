...
public abstract class RevFlagFilter extends RevFilter {
	...
	private static class HasAll extends org.eclipse.jgit.revwalk.filter.RevFlagFilter {
		HasAll(RevFlagSet m) {
			super(m);
		}
	...
	private static class HasAny extends org.eclipse.jgit.revwalk.filter.RevFlagFilter {
		HasAny(RevFlagSet m) {
			super(m);
		}
