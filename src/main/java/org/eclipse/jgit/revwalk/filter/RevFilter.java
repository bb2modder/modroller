 ...
 * {@link RevWalk#setRevFilter(org.eclipse.jgit.revwalk.filter.RevFilter)} prior to
 * starting traversal.
 * <p>
...
public abstract class RevFilter {
	...
	public static final org.eclipse.jgit.revwalk.filter.RevFilter ALL = new AllFilter();

	private static final class AllFilter extends org.eclipse.jgit.revwalk.filter.RevFilter {
		@Override
	...
	public static final org.eclipse.jgit.revwalk.filter.RevFilter NONE = new NoneFilter();

	private static final class NoneFilter extends org.eclipse.jgit.revwalk.filter.RevFilter {
		@Override
		public boolean include(RevWalk walker, RevCommit c) {
			return false;
		}
	 ...
	 * @since 4.4
	 */
	public static final org.eclipse.jgit.revwalk.filter.RevFilter ONLY_MERGES = new OnlyMergesFilter();

	private static final class OnlyMergesFilter extends org.eclipse.jgit.revwalk.filter.RevFilter {
	...
	public static final org.eclipse.jgit.revwalk.filter.RevFilter NO_MERGES = new NoMergesFilter();

	private static final class NoMergesFilter extends org.eclipse.jgit.revwalk.filter.RevFilter {
		@Override
		public boolean include(RevWalk walker, RevCommit c) {
			return c.getParentCount() < 2;
		}
	 ...
	 */
	public static final org.eclipse.jgit.revwalk.filter.RevFilter MERGE_BASE = new MergeBaseFilter();

	private static final class MergeBaseFilter extends org.eclipse.jgit.revwalk.filter.RevFilter {
		@Override
		public boolean include(RevWalk walker, RevCommit c) {
	 ...
	 */
	public org.eclipse.jgit.revwalk.filter.RevFilter negate() {
	 ...
	 */
	@Override
	public abstract org.eclipse.jgit.revwalk.filter.RevFilter clone();
