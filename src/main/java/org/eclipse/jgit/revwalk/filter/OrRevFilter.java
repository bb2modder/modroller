...
public abstract class OrRevFilter extends RevFilter {
	...
	private static class Binary extends org.eclipse.jgit.revwalk.filter.OrRevFilter {
	...
	private static class List extends org.eclipse.jgit.revwalk.filter.OrRevFilter {
