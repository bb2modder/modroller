...
public abstract class CommitTimeRevFilter extends RevFilter {
	...
	private static class Before extends org.eclipse.jgit.revwalk.filter.CommitTimeRevFilter {
		Before(long ts) {
			super(ts);
		}
	...
	private static class After extends org.eclipse.jgit.revwalk.filter.CommitTimeRevFilter {
		After(long ts) {
			super(ts);
		}
	...
	private static class Between extends org.eclipse.jgit.revwalk.filter.CommitTimeRevFilter {
