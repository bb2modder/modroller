...
public class FollowFilter extends TreeFilter {
	 ...
	 * @since 3.0
	 */
	public static org.eclipse.jgit.revwalk.FollowFilter create(String path, DiffConfig cfg) {
		return new org.eclipse.jgit.revwalk.FollowFilter(PathFilter.create(path), cfg);
	}
	...
	public TreeFilter clone() {
		return new org.eclipse.jgit.revwalk.FollowFilter(path.clone(), cfg);
	}
