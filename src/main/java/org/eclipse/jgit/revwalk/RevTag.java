...
public class RevTag extends RevObject {
	 ...
	 */
	public static org.eclipse.jgit.revwalk.RevTag parse(byte[] raw) throws CorruptObjectException {
	 ...
	 *             the tag contains a malformed header that cannot be handled.
	 */
	public static org.eclipse.jgit.revwalk.RevTag parse(RevWalk rw, byte[] raw)
			throws CorruptObjectException {
		try (ObjectInserter.Formatter fmt = new ObjectInserter.Formatter()) {
			org.eclipse.jgit.revwalk.RevTag r = rw.lookupTag(fmt.idFor(Constants.OBJ_TAG, raw));
