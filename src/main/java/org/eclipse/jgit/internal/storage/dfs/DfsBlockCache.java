...
/**
 * Caches slices of a
 * {@link BlockBasedFile} in memory for
 * faster read access.
 * <p>
...
public final class DfsBlockCache {
	private static volatile org.eclipse.jgit.internal.storage.dfs.DfsBlockCache cache;
	...
	public static void reconfigure(DfsBlockCacheConfig cfg) {
		cache = new org.eclipse.jgit.internal.storage.dfs.DfsBlockCache(cfg);
	}
	 ...
	 */
	public static org.eclipse.jgit.internal.storage.dfs.DfsBlockCache getInstance() {
		return cache;
	}
	...
	public boolean hasBlock0(DfsStreamKey key) {
		...
		org.eclipse.jgit.internal.storage.dfs.DfsBlock v = scan(e1, key, 0);
	 ...
	 */
	org.eclipse.jgit.internal.storage.dfs.DfsBlock getOrLoad(BlockBasedFile file, long position, DfsReader ctx,
		...
		org.eclipse.jgit.internal.storage.dfs.DfsBlock v = scan(e1, key, position);
		...
		try {
			...
			Ref<org.eclipse.jgit.internal.storage.dfs.DfsBlock> ref = new Ref<>(key, position, v.size(), v);
			ref.hot = true;
			for (;;) {
