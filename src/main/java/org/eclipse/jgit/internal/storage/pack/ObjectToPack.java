...
public class ObjectToPack extends PackedObjectInfo {
	 ...
	 */
	public final org.eclipse.jgit.internal.storage.pack.ObjectToPack getDeltaBase() {
		if (deltaBase instanceof org.eclipse.jgit.internal.storage.pack.ObjectToPack)
			return (org.eclipse.jgit.internal.storage.pack.ObjectToPack) deltaBase;
		return null;
	}
