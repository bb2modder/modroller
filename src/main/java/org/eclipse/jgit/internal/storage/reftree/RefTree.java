...
public class RefTree {
	 ...
	 */
	public static org.eclipse.jgit.internal.storage.reftree.RefTree newEmptyTree() {
		return new org.eclipse.jgit.internal.storage.reftree.RefTree(DirCache.newInCore());
	}
	 ...
	 */
	public static org.eclipse.jgit.internal.storage.reftree.RefTree read(ObjectReader reader, RevTree tree)
			throws MissingObjectException, IncorrectObjectTypeException,
			CorruptObjectException, IOException {
		return new org.eclipse.jgit.internal.storage.reftree.RefTree(DirCache.read(reader, tree));
	}
	 ...
	 * ({@link Ref#isPeeled()} is true). If the reference
	 * points to an annotated tag, the returned reference will be peeled and
	 * contain {@link Ref#getPeeledObjectId()}.
	 * <p>
	 ...
	 */
	public org.eclipse.jgit.internal.storage.reftree.RefTree copy() {
		org.eclipse.jgit.internal.storage.reftree.RefTree r = new org.eclipse.jgit.internal.storage.reftree.RefTree(DirCache.newInCore());
