 ...
 * <p>
 * Unlike {@link ReceiveCommand} (which can only
 * update a reference to an {@link ObjectId}), a RefTree
...
public class Command {
	 ...
	 */
	public static void abort(Iterable<org.eclipse.jgit.internal.storage.reftree.Command> commands, @Nullable String why) {
		if (why == null || why.isEmpty()) {
			why = JGitText.get().transactionAborted;
		}
		for (org.eclipse.jgit.internal.storage.reftree.Command c : commands) {
