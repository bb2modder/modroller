...
final class DeltaWindowEntry {
	org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry prev;
	org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry next;
	ObjectToPack object;
	...
	final void makeNext(org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry e) {
	...
	static org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry createWindow(int cnt) {
		...
		org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry res = new org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry();
		org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry p = res;
		for (int i = 0; i < cnt; i++) {
			org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry e = new org.eclipse.jgit.internal.storage.pack.DeltaWindowEntry();
			e.prev = p;
			p.next = e;
			p = e;
		}
