...
public abstract class BlockSource implements AutoCloseable {
	 ...
	 */
	public static org.eclipse.jgit.internal.storage.io.BlockSource from(byte[] content) {
		return new org.eclipse.jgit.internal.storage.io.BlockSource() {
			@Override
	 ...
	 */
	public static org.eclipse.jgit.internal.storage.io.BlockSource from(FileInputStream in) {
	 ...
	 */
	public static org.eclipse.jgit.internal.storage.io.BlockSource from(FileChannel ch) {
		return new org.eclipse.jgit.internal.storage.io.BlockSource() {
			@Override
