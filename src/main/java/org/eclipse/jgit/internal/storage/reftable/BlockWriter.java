...
class BlockWriter {
	...
	void writeTo(org.eclipse.jgit.internal.storage.reftable.ReftableOutputStream os) throws IOException {
	...
	abstract static class Entry {
		static int compare(Entry ea, Entry eb) {
			byte[] a = ea.key;
			byte[] b = eb.key;
			return org.eclipse.jgit.internal.storage.reftable.BlockWriter.compare(a, 0, a.length, b, 0, b.length);
		}
		...
		void writeKey(org.eclipse.jgit.internal.storage.reftable.ReftableOutputStream os) {
		...
		abstract void writeValue(org.eclipse.jgit.internal.storage.reftable.ReftableOutputStream os) throws IOException;
	}
	...
	static class IndexEntry extends Entry {
		...
		@Override
		void writeValue(org.eclipse.jgit.internal.storage.reftable.ReftableOutputStream os) {
	...
	static class RefEntry extends Entry {
		...
		@Override
		void writeValue(org.eclipse.jgit.internal.storage.reftable.ReftableOutputStream os) throws IOException {
