...
public class DfsRepositoryDescription {
	...
	public boolean equals(Object b) {
		if (b instanceof org.eclipse.jgit.internal.storage.dfs.DfsRepositoryDescription){
			String name = getRepositoryName();
			String otherName = ((org.eclipse.jgit.internal.storage.dfs.DfsRepositoryDescription) b).getRepositoryName();
