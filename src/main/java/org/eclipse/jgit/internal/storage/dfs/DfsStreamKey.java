...
public abstract class DfsStreamKey {
	 ...
	 */
	public static org.eclipse.jgit.internal.storage.dfs.DfsStreamKey of(DfsRepositoryDescription repo, String name,
	...
	private static final class ByteArrayDfsStreamKey extends org.eclipse.jgit.internal.storage.dfs.DfsStreamKey {
	...
	static final class ForReverseIndex extends org.eclipse.jgit.internal.storage.dfs.DfsStreamKey {
		private final org.eclipse.jgit.internal.storage.dfs.DfsStreamKey idxKey;

		ForReverseIndex(org.eclipse.jgit.internal.storage.dfs.DfsStreamKey idxKey) {
		...
		@Override
		public boolean equals(Object o) {
			return o instanceof org.eclipse.jgit.internal.storage.dfs.DfsStreamKey.ForReverseIndex
					&& idxKey.equals(((org.eclipse.jgit.internal.storage.dfs.DfsStreamKey.ForReverseIndex) o).idxKey);
		}
	}
}
