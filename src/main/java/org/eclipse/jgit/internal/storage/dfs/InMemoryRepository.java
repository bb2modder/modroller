...
public class InMemoryRepository extends DfsRepository {
	...
	public static class Builder
			extends DfsRepositoryBuilder<Builder, org.eclipse.jgit.internal.storage.dfs.InMemoryRepository> {
		@Override
		public org.eclipse.jgit.internal.storage.dfs.InMemoryRepository build() throws IOException {
			return new org.eclipse.jgit.internal.storage.dfs.InMemoryRepository(this);
		}
	}
	...
	protected class MemRefDatabase extends DfsReftableDatabase {
		...
		protected MemRefDatabase() {
			super(org.eclipse.jgit.internal.storage.dfs.InMemoryRepository.this);
		}
