...
public class ReftableWriter {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.internal.storage.reftable.ReftableWriter setConfig(ReftableConfig cfg) {
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.internal.storage.reftable.ReftableWriter setMinUpdateIndex(long min) {
		minUpdateIndex = min;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.internal.storage.reftable.ReftableWriter setMaxUpdateIndex(long max) {
		maxUpdateIndex = max;
		return this;
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.internal.storage.reftable.ReftableWriter begin() {
		if (out != null) {
	 ...
	 */
	public org.eclipse.jgit.internal.storage.reftable.ReftableWriter sortAndWriteRefs(Collection<Ref> refsToPack)
			throws IOException {
	 ...
	 *             if reftable cannot be written.
	 */
	public org.eclipse.jgit.internal.storage.reftable.ReftableWriter finish() throws IOException {
	...
	public static class Stats {
		...
		Stats(org.eclipse.jgit.internal.storage.reftable.ReftableWriter w, ReftableOutputStream o) {
