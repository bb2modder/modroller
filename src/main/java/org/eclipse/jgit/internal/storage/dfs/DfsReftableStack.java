...
public class DfsReftableStack implements AutoCloseable {
	 ...
	 */
	public static org.eclipse.jgit.internal.storage.dfs.DfsReftableStack open(DfsReader ctx, List<DfsReftable> files)
			throws IOException {
		org.eclipse.jgit.internal.storage.dfs.DfsReftableStack stack = new org.eclipse.jgit.internal.storage.dfs.DfsReftableStack(files.size());
		boolean close = true;
		try {
