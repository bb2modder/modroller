...
/**
 * A Ketch replica, either {@link LocalReplica}
 ...
 * {@link KetchLeader} commits an agreed upon
 ...
 * {@link KetchLeader}. Some state may be
 * accessed by the leader thread and uses the leader's own
 * {@link KetchLeader#lock} to protect shared
 * data.
 */
public abstract class KetchReplica {
	 ...
	 * <p>
	 * Called with {@link KetchLeader#lock} held
	 * by caller.
	 */
	 ...
	 */
	void pushTxnAcceptedAsync(org.eclipse.jgit.internal.ketch.Round round) {
	...
	static class WeakRetryPush extends WeakReference<org.eclipse.jgit.internal.ketch.KetchReplica>
			implements Callable<Void> {
		WeakRetryPush(org.eclipse.jgit.internal.ketch.KetchReplica r) {
			super(r);
		}

		@Override
		public Void call() throws Exception {
			org.eclipse.jgit.internal.ketch.KetchReplica r = get();
			if (r != null) {
				r.doRetryPush();
			}
			return null;
	 ...
	 * {@link KetchLeader#lock} held by caller.
	 *
	 * @param req
	...
	void afterPush(@Nullable Repository repo, ReplicaPushRequest req) {
		...
		if (repo != null && acceptCmd != null && acceptCmd.getResult() != OK
			...
			try (org.eclipse.jgit.internal.ketch.LagCheck lag = new org.eclipse.jgit.internal.ketch.LagCheck(this, repo)) {
