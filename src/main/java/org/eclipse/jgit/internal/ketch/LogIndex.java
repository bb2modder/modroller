...
public class LogIndex extends ObjectId {
	static org.eclipse.jgit.internal.ketch.LogIndex unknown(AnyObjectId id) {
		return new org.eclipse.jgit.internal.ketch.LogIndex(id, 0);
	}
	...
	org.eclipse.jgit.internal.ketch.LogIndex nextIndex(AnyObjectId id) {
		return new org.eclipse.jgit.internal.ketch.LogIndex(id, index + 1);
	}
	 ...
	 *         log position.
	 */
	boolean isBefore(org.eclipse.jgit.internal.ketch.LogIndex c) {
