...
public class ReplicaConfig {
	 ...
	 */
	public static org.eclipse.jgit.internal.ketch.ReplicaConfig newFromConfig(Config cfg, String name) {
		return new org.eclipse.jgit.internal.ketch.ReplicaConfig().fromConfig(cfg, name);
	}
	 ...
	 * @return {@code this}
	 */
	public org.eclipse.jgit.internal.ketch.ReplicaConfig fromConfig(Config cfg, String name) {
