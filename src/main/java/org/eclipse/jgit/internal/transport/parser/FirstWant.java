...
public class FirstWant {
	 ...
	 */
	public static org.eclipse.jgit.internal.transport.parser.FirstWant fromLine(String line) throws PackProtocolException {
		String wantLine;
		...
		return new org.eclipse.jgit.internal.transport.parser.FirstWant(wantLine, capabilities, agent);
	}
