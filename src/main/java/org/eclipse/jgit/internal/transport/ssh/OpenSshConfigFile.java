...
public class OpenSshConfigFile implements SshConfigStore {
	...
	/**
	 * Creates a new {@link org.eclipse.jgit.internal.transport.ssh.OpenSshConfigFile} that will read the config from
	 ...
	 * all been done.
	 */
	public static class HostEntry implements HostConfig {
